...
class MayorGeneral(models.Model):
	...
	debito=models.DecimalField(max_digits=18, decimal_places=2, default=False, blank=False, null=False, verbose_name="Debito")
	credito=models.DecimalField(max_digits=18, decimal_places=2, default=False, blank=False, null=False, verbose_name="Credito")
	balance=models.DecimalField(max_digits=18, decimal_places=2, default=False, blank=False, null=False, verbose_name="Balance")
