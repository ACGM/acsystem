...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('cuotaAhorroQ1', models.DecimalField(null=True, max_digits=18, decimal_places=2, blank=True)),
                ('cuotaAhorroQ2', models.DecimalField(null=True, max_digits=18, decimal_places=2, blank=True)),
            ],
            options={
            },
            bases=(models.Model,),
